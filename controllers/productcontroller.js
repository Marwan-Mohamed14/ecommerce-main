    ...
    exports.addProduct = (req, res) => {
        upload.single('productImage')(req, res, async function (err) {
            ...
            const imageUrl = req.file ? '/public/Pictures/' + req.file.filename : '';
    ...
    exports.updateProductById = (req, res) => {
        ...
        upload.single('productImage')(req, res, async function (err) {
            ...
            if (req.file) {
                ...
                updates.image = '/public/Pictures/' + req.file.filename;
            }
            ...
            try {
                ...
                if (req.file && product.image) {
                    const oldImagePath = path.join(__dirname, '..', 'Pictures', path.basename(product.image));
